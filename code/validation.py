...
def validate_hard(model_path, device, set):
    val_dataset = ClevrDataset(cfg.DATASET.DATA_DIR, set, 'val')
    val_loader = torch.utils.data.DataLoader(val_dataset, batch_size=10, shuffle=False, drop_last=False, num_workers=cfg.WORKERS, collate_fn=collate_fn)
